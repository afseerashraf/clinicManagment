                ...
                @foreach ($patients as $patient)
                    <tr>
                        ...
                        <td>
                            ...
                            @if ($patient->trashed())
                                <a href="{{ route('patient.restore', encrypt($patient->id)) }}"
                                    class="btn btn-outline-success">
                                    ♻️ Restore
                                </a>
                            @else
                                <a href="{{ route('patient.delete', encrypt($patient->id)) }}"
                                    class="btn btn-outline-danger deletePatient">
                                    🗑️ Delete
                                </a>
                            @endif

                            <a href="{{ route('patient.edit', encrypt($patient->id)) }}" class="btn btn-outline-warning">
                                ✏️ Update
                            </a>
