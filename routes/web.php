...
//Route::middleware(AdminOrReceptionist::class)->group(function(){ // this is customer middleware for admin and receptionist their can only access these patients routes.
